...
TOKEN = '7326282713:AAFdZ-hAlwt5uE_ccCECayvnvWicLtzzmLE'
...
def handle_message(message):
    ...
    elif message.text == "🤖VENOM SERVER":
        bot.reply_to(message, "*🤖VENOM SERVER RUNNING....*", parse_mode='Markdown')
...
if __name__ == "__main__":
    ...
    logging.info("VENOM SERVER RUNNING.....")
    while True:
        try:
